...
ls -l
lcg-cp file://$TOP/BH_dummy.py $STOR_DIR/BH_dummy_$tag.py
lcg-cp file://$TOP/BH_dummy2.py $STOR_DIR/BH_dummy2_$tag.py
lcg-cp file://$TOP/BH_dummyMinBias.py $STOR_DIR/BH_dummyMinBias_$tag.py 
