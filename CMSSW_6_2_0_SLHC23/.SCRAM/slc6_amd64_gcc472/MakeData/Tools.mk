...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/blackhat/0.9.9/include
...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/boost/1.51.0-cms5/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/boost/1.51.0-cms5/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/boost/1.51.0-cms5/include
...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/cascade/2.2.04-cms6/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/charybdis/1.003-cms6/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/classlib/3.1.3-cms2/include
...
ALL_TOOLS      += curl
curl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/curl/7.28.0-cms3/include
curl_EX_LIB := curl
...
ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/dcap/2.47.8/include
dcap_EX_LIB := dcap
...
ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/eigen/3.2.2/include
...
ALL_TOOLS      += evtgenlhc
evtgenlhc_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/evtgenlhc/9.1-cms5
...
ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/fastjet/3.0.3-cms/include
fastjet_EX_LIB := fastjetplugins fastjettools siscone siscone_spherical fastjet

ALL_TOOLS      += fftjet
fftjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/fftjet/1.3.1-cms/include
fftjet_EX_LIB := fftjet

ALL_TOOLS      += fftw3
fftw3_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/fftw3/3.3.2-cms/include
fftw3_EX_LIB := fftw3

ALL_TOOLS      += frontier_client
frontier_client_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/frontier_client/2.8.11/include
...
ALL_TOOLS      += gdbm
gdbm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/gdbm/1.10-cms/include
gdbm_EX_LIB := gdbm
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/geant4/9.6.p02-cms/include
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/hector/1_3_4-cms25/include
...
hepmc_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/hepmc/2.06.07-cms3/include
...
ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/herwig/6.521-cms4/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/herwigpp/2.5.0-cms7/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/jimmy/4.2-cms7/include

ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/ktjet/1.06-cms5/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/lhapdf/5.9.1/include
...
ALL_TOOLS      += libpng
libpng_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/libpng/1.2.46-cms2/include
libpng_EX_LIB := png
libpng_EX_USE := zlib

ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/libtiff/3.9.4-cms2/include
libtiff_EX_LIB := tiff
...
ALL_TOOLS      += libxml2
libxml2_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/libxml2/2.7.7-cms2/include/libxml2
libxml2_EX_LIB := xml2
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/mctester/1.25.0a-cms24/include
...
ALL_TOOLS      += protobuf
protobuf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/protobuf/2.4.1-cms2/include
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/pythia8/185/include
pythia8_EX_LIB := pythia8 pythia8tohepmc
pythia8_EX_USE := cxxcompiler hepmc lhapdf

ALL_TOOLS      += python-ldap
python-ldap_EX_USE := openssl openldap python

ALL_TOOLS      += python
python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/python/2.7.3-cms5/include/python2.7
python_EX_LIB := python2.7
python_EX_USE := sockets

ALL_TOOLS      += qd
qd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/qd/2.3.13/include
...
ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/rivet/1.8.2-cms9/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/lcg/roofit/5.34.07-cms5/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/lcg/root/5.34.07-cms5/include

ALL_TOOLS      += rootcint
rootcint_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/lcg/root/5.34.07-cms5/cint
...
ALL_TOOLS      += self
self_EX_INCLUDE := /afs/cern.ch/work/a/aspiezia/TrackTrigger/PCAMethod/CMSSW_6_2_0_SLHC23/src /afs/cern.ch/work/a/aspiezia/TrackTrigger/PCAMethod/CMSSW_6_2_0_SLHC23/include/LCG /cvmfs/cms.cern.ch/slc6_amd64_gcc472/cms/cmssw/CMSSW_6_2_0_SLHC23/src /cvmfs/cms.cern.ch/slc6_amd64_gcc472/cms/cmssw/CMSSW_6_2_0_SLHC23/include/LCG
self_EX_LIBDIR := /afs/cern.ch/work/a/aspiezia/TrackTrigger/PCAMethod/CMSSW_6_2_0_SLHC23/lib/slc6_amd64_gcc472 /afs/cern.ch/work/a/aspiezia/TrackTrigger/PCAMethod/CMSSW_6_2_0_SLHC23/external/slc6_amd64_gcc472/lib /cvmfs/cms.cern.ch/slc6_amd64_gcc472/cms/cmssw/CMSSW_6_2_0_SLHC23/lib/slc6_amd64_gcc472 /cvmfs/cms.cern.ch/slc6_amd64_gcc472/cms/cmssw/CMSSW_6_2_0_SLHC23/external/slc6_amd64_gcc472/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/sherpa/2.1.1/include/SHERPA-MC
...
ALL_TOOLS      += sqlite
sqlite_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/sqlite/3.7.10-cms/include
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/tauolapp/1.0.5-cms3/include
tauolapp_EX_LIB := TauolaCxxInterface TauolaFortran
tauolapp_EX_USE := hepmc f77compiler

ALL_TOOLS      += tbb
tbb_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/tbb/41_20120718oss-cms/include
tbb_EX_LIB := tbb
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/thepeg/1.7.0-cms7/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := lhapdf gsl

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/tkonlinesw/2.7.0-cms6/include
...
ALL_TOOLS      += vdt
vdt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/cms/vdt/v0.3.2-cms/include
vdt_EX_LIB := vdt
...
ALL_TOOLS      += xdaq
xdaq_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/xdaq/VR17173-cms6/include /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/xdaq/VR17173-cms6/include/linux
...
xdaqheader_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/xdaq/VR17173-cms6/include
...
ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/xrootd/3.2.4-cms5/include/xrootd
...
ALL_TOOLS      += zlib
zlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/zlib/1.2.7/include
zlib_EX_LIB := z
